...
const AppCustom: React.FC = () => {
    return (
        <section className="px-3 xl:px-0 py-12 xl:py-28 bg-[var(--color-primary)] flex flex-col items-center justify-center gap-8">
          ...
          <Link href="/planes" className="bg-white hover:text-white hover:bg-orange-600 text-[var(--heading-color)] font-bold py-4 px-6 rounded-lg shadow-lg transition-colors text-md whitespace-nowrap">
            ¡Comienza gratis!
          </Link>
        </section>
    )
