...
const Pricing: React.FC = () => {
  ...
  return (
    <div id="planes" className="flex flex-col items-center py-16 pt-32 px-5 xl:py-32 xl:px-20 w-full h-full">
      ...
      <p className="md:w-[80%] text-[1rem] text-center text-gray-600 mb-20">¡COMIENZA GRATIS! TE DAMOS UNA CUENTA CON $100.000 EN CRÉDITOS PARA QUE EMPIECES A RECIBIR FLUJO DE CAJA ANTICIPADO DE TUS CLIENTES FRECUENTES COMIENCES A CREAR TU COMUNIDAD Y GENERAR RECOMPRA.</p>
